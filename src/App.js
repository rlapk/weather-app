    ...
    <div className="app">
      ...
      <div className = "condition">
        ...
        <div className="container"> 
          ...
          <CityData name={name} icon={icon} temp={temp} units={units} description={description} feels_like={feels_like} humidity={humidity} speed={speed}/> 
          
          {/* Trying to stack city cards*/}
          ...
          {//data.length > 1 && 
            data.map((city) => {
              ...
              console.log("----")
              //return <CityData name={city.name} icon={city.weather[0].icon} temp={city.main.temp} units={units} description={city.weather[0].description} feels_like={city.main.feels_like} humidity={city.main.humidity} speed={city.wind.speed}/>;
          })}
